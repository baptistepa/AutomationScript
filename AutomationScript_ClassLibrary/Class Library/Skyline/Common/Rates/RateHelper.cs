namespace Skyline.DataMiner.Library.Common.Rates
{
	...
	[DllImport("Microsoft.CSharp.dll")]
	[Serializable]
	...
	public class Rate32OnDateTime : RateOnDateTime<uint, Counter32WithDateTime>
	{
		...
		/// <summary>
		/// Deserializes a JSON <see cref="System.String"/> to a <see cref="Rate32OnDateTime"/> instance.<br/>
		/// Throws a <see cref="JsonReaderException"/> if the given <paramref name="rateHelperSerialized"/> is an invalid string representation of a <see cref="Rate32OnDateTime"/> instance.
		/// </summary>
		...
		{
			var rateCounter = new Counter32WithDateTime(newCounter, time);
	...
	public class Rate32OnTimeSpan : RateOnTimeSpan<uint, Counter32WithTimeSpan>
	{
		...
		/// <summary>
		/// Deserializes a JSON <see cref="System.String"/> to a <see cref="Rate32OnTimeSpan"/> instance.<br/>
		/// Throws a <see cref="JsonReaderException"/> if the given <paramref name="rateHelperSerialized"/> is an invalid string representation of a <see cref="Rate32OnTimeSpan"/> instance.
		/// </summary>
	...
	public class Rate64OnDateTime : RateOnDateTime<ulong, Counter64WithDateTime>
	{
		...
		/// <summary>
		/// Deserializes a JSON <see cref="System.String"/> to a <see cref="Rate64OnDateTime"/> instance.<br/>
		/// Throws a <see cref="JsonReaderException"/> if the given <paramref name="rateHelperSerialized"/> is an invalid string representation of a <see cref="Rate64OnDateTime"/> instance.
		/// </summary>
		...
		{
			var rateCounter = new Counter64WithDateTime(newCounter, time);
			return Calculate(rateCounter, faultyReturn);
		}
	}
	...
	public class Rate64OnTimeSpan : RateOnTimeSpan<ulong, Counter64WithTimeSpan>
	{
		...
		/// <summary>
		/// Deserializes a JSON <see cref="System.String"/> to a <see cref="Rate64OnTimeSpan"/> instance.<br/>
		/// Throws a <see cref="JsonReaderException"/> if the given <paramref name="rateHelperSerialized"/> is an invalid string representation of a <see cref="Rate64OnTimeSpan"/> instance.
		/// </summary>
